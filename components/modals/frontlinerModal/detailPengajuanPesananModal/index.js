...
const DetailPengajuanPesanan = ({ isOpen, onClose }) => {
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
            ...
            <Flex direction="column">
              <Flex w="full" borderBottomWidth={2} py="2">
                ...
                <Flex align="center">
                  ...
                  <Text ml={2}> PT Pindad (Persero)</Text>
                </Flex>
              </Flex>
              <Box py="2">
                <Flex>
                  ...
                  <Box h="full" flex={1.5}>
                    <VStack w="full" align="start">
                      ...
                      <HStack>
                        ...
                        <Text>devaaji5@gmail.com</Text>
                      </HStack>
                      <HStack>
                        <Icon w={5} h={5} as={MdCall} />
                        <Text>08979111476</Text>
                      </HStack>
                      <Text>
                        Jln. Branti Raya Desa Pejambon Kec. Negeri Katon Kab.
                        Pesawaran
                      </Text>
                    </VStack>
                  </Box>
